...
class ChurnPredictor:
    """
    ChurnPredictor builds an abstraction between H2O Wave ML library and the Churn Risk app
    giving the developer freedom to integrate any 3rd party machine library
